...
Debug.createDevTool = function(){
	var option = [
		ItemModel.Option(Debug.ghost,'Hayalet'),
		ItemModel.Option(Debug.teleportToQuestMarker,'QM\'ye Işınlan'),
		ItemModel.Option(Debug.invincible,'Görünmez'),
		ItemModel.Option(Debug.completeQuest,'Görevi Tamamla'),
		ItemModel.Option(Debug.openAdminDialog,'Admin Paneli'),
	];
